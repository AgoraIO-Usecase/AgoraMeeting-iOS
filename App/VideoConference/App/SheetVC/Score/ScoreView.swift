...
class ScoreView: UIView {
    ...
    var starView1: ScoreStarView!
    var starView2: ScoreStarView!
    var starView3: ScoreStarView!
    ...
    private func setup() {
        starView1 = Bundle.main.loadNibNamed("ScoreStarView", owner: nil, options: nil)?.first as? ScoreStarView
        starView2 = Bundle.main.loadNibNamed("ScoreStarView", owner: nil, options: nil)?.first as? ScoreStarView
        starView3 = Bundle.main.loadNibNamed("ScoreStarView", owner: nil, options: nil)?.first as? ScoreStarView
...
extension ScoreView: UITextViewDelegate {
