...
class Log {
    ...
    private let logger = AgoraLogger(folderPath: folderPath, filePrefix: "MeetingUI", maximumNumberOfFiles: 5)
    ...
    static func string(text: String, tag: String, type: AgoraLogType) -> String {
        ...
        switch type {
        case .debug:
            indicatedString = "[MeetingUI][Debug]"
            break
        case .info:
            indicatedString = "[MeetingUI][Info]"
            break
        case .error:
            indicatedString = "[MeetingUI][Error]"
            break
        case .warning:
            indicatedString = "[MeetingUI][Warning]"
            break
        default:
            indicatedString = "[MeetingUI][Unknow]"
            break
        }
