...
- (void)layout {
    ...
    [NSLayoutConstraint activateConstraints:@[
        [_collectionViewVideo.topAnchor constraintEqualToAnchor:self.topAnchor],
        ...
        [_collectionViewVideo.bottomAnchor constraintEqualToAnchor:self.bottomAnchor]
    ]];
    
    _collectionViewAudio.translatesAutoresizingMaskIntoConstraints = false;
    [NSLayoutConstraint activateConstraints:@[
        [_collectionViewAudio.topAnchor constraintEqualToAnchor:self.topAnchor],
        ...
        [_collectionViewAudio.bottomAnchor constraintEqualToAnchor:self.bottomAnchor]
    ]];
    ...
    [NSLayoutConstraint activateConstraints:@[
        [_speakerView.topAnchor constraintEqualToAnchor:self.topAnchor],
        ...
        [_speakerView.bottomAnchor constraintEqualToAnchor:self.bottomAnchor]
    ]];
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [_videoScrollView.bottomAnchor constraintEqualToAnchor:self.bottomAnchor],
