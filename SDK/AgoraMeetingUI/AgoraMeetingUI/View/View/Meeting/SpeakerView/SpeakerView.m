...
- (void)setup {
    ...
    UIImage *image = [UIImage meetingUIImageName:@"平铺视图"];
    [_rightButton setImage:image forState:UIControlStateNormal];
    [_closeScreenShareButton setTitle:NSLocalizedStringFromTableInBundle(@"ui_t7", nil, NSBundle.meetingUIBundle, nil) forState:UIControlStateNormal];
    ...
    [_boardButton setTitle:NSLocalizedStringFromTableInBundle(@"ui_t8", nil, NSBundle.meetingUIBundle, nil) forState:UIControlStateNormal];
    ...
    _tipLabel.text = NSLocalizedStringFromTableInBundle(@"ui_t3", nil, NSBundle.meetingUIBundle, nil);
