...
extension VideoCellSheetView {
    struct Info: Equatable {
        ...
        var title: String {
            switch actionType {
            case .closeAudio:
                return MeetingUILocalizedString("mem_t13", comment: "")
            case .closeVideo:
                return MeetingUILocalizedString("mem_t2", comment: "")
            case .setAsHost:
                return MeetingUILocalizedString("mem_t12", comment: "")
            case .abandonHost:
                return MeetingUILocalizedString("mem_t8", comment: "")
            case .becomeHost:
                return MeetingUILocalizedString("meeting_t25", comment: "")
            case .remove:
                return MeetingUILocalizedString("mem_t11", comment: "")
            }
        }
