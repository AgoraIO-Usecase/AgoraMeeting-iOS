...
class ASCheckBoxAlertVC: UIViewController {
    ...
    weak var delegate: ASCheckBoxAlertVCDelegate?
    ...
    private func setup() {
        ...
        cancleButton.setTitle(MeetingUILocalizedString("mem_t3", comment: ""), for: .normal)
        ...
        sureButton.setTitle(MeetingUILocalizedString("meeting_t56", comment: ""), for: .normal)
        ...
        let imageNormal = UIImage.meetingUIImageName("Checkbox")
        let imageSelected = UIImage.meetingUIImageName("Checkboxblue")
    ...
    func show(in vc: UIViewController, style: Style) {
        config(style: style)
    ...
    func config(style: Style) {
        self.style = style
        titleLabel.text = style == .audio ? MeetingUILocalizedString("meeting_t6", comment: "") : MeetingUILocalizedString("meeting_t5", comment: "")
        detailLabel.text = style == .audio ? MeetingUILocalizedString("meeting_t57", comment: "") : MeetingUILocalizedString("meeting_t58", comment: "")
    }
