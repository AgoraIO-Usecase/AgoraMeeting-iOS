...
extension String {
    ...
    var inValidUserNameText: String? {
        if count <= 0 {
            return MeetingUILocalizedString("UserNameVerifyEmptyText", comment: "")
        }
        if count < 3 {
            return MeetingUILocalizedString("UserNameMinVerifyText", comment: "")
        }
        if count > 20 {
            return MeetingUILocalizedString("UserNameMaxVerifyText", comment: "")
        }
        return nil
    }
    ...
    var inValidPsdText: String? {
        if count > 20 {
            return MeetingUILocalizedString("PsdMaxVerifyText", comment: "")
        }
        return nil
    }
    ...
    var inValidRoomName: String? {
        ...
        if count <= 3 {
            return MeetingUILocalizedString("RoomNameMinVerifyText", comment: "")
        }
        if count > 50 {
            return MeetingUILocalizedString("RoomNameMaxVerifyText", comment: "")
        }
        return nil
    }
