...
详见项目指南中的[前提条件](https://github.com/AgoraIO-Usecase/AgoraMeeting/blob/master/README.zh.md#%E5%89%8D%E6%8F%90%E6%9D%A1%E4%BB%B6)。
...
- 在`VideoConference`Target的info.plistApp Group ID（`AppGroupId`字段）
- 在SampleHandler.swift Line54填写App Group ID
